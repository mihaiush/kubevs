...
httpd.socket = ssl_context.wrap_socket(httpd.socket, keyfile='{}/key'.format(CONFIG['helper']['authDir']), certfile='{}/cert'.format(CONFIG['helper']['authDir']), server_side=True)
